/*
+--------------------------------------------------------------------------+-------+-----------+
¦Programa  ¦EPCFAT01  ¦ Autor ¦ Crislei de Almeida Toledo                  | Data  ¦ 05.05.2006¦
+----------+---------------------------------------------------------------+-------+-----------+
...
@ 043,013 SAY oSay3 Var OemToAnsi("Data Ref. Inicial") Of oDlgParam Pixel 
@ 053,013 GET oDtEntIni Var dDtEntIni Of oDlgParam Pixel 
@ 043,070 SAY oSay4 Var OemToAnsi("Data Ref. Final") Of oDlgParam Pixel 
@ 053,080 GET oDtEntFim Var dDtEntFim Of oDlgParam Pixel 
...
IndRegua("TRB",cFileWork,"E1_FILIAL+E1_CODCONT+DTOS(E1_DATAREF)",,,OemToAnsi("Selecionando Registros"))
...
cQuery += " WHERE E1_DATAREF BETWEEN '" + DTOS(dDtEntIni) + "' AND '" + DTOS(dDtEntFim) + "' AND "
cQuery += " E1_CODCONT BETWEEN '" + cContInic + "' AND '" + cContFina + "' AND "   
cQuery += " E1_TIPO = 'PR' AND "
cQuery += " E1_PREFIXO = 'EST' AND "
cQuery += " SE1.D_E_L_E_T_ <> '*' "
cQuery += " ORDER BY E1_CODCONT, E1_DATAREF "
